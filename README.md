# Excel helper for projectile motion
...
![Projectile motion demo](Excel_Projectile_Motion_Helper.png)

This project is an Excel-based tool I built during my A-Levels to help visualise **projectile motion** using the standard SUVAT / kinematics equations. Changing the initial conditions updates the trajectory and calculated values.
